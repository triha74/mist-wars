...
### **The Power Formula**
When a hit (7+) is scored, the amount of "Potential Power" generated is:
> **$\text{Sum of Strengths} - \text{Sum of Weaknesses}$** (Applied to that specific roll).
>
> * **The Floor Rule:** The Potential Power is **always at least 1**, even if weaknesses outweigh strengths.
